...
class ExitGate {
    ...
    public boolean processExit(Ticket ticket) {
        ...
        System.out.println("Vehicle with license " + ticket.getVehicle().getVehicleNo() + " exited. Spot "
                + ticket.getParkingSpot().getSpotNumber() + " is now free.");
